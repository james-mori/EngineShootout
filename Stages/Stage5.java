...
public class Stage5 extends GameStage {
    ...
    public BodyImage ballImage() {
        return new BodyImage("data/objects/balls/tumbleweed.png", 2.3f*ballSizeConstant());
    }
    ...
    public String getLeftCarImage() {
        return "data/objects/cars/yellowCarLeft.png";
    }
    ...
    public String getRightCarImage() {
        return "data/objects/cars/purpleCarRight.png";
    }
    ...
    public String musicPath() {
        return "data/audio/music/stage5Music.wav";
    }
