...
public class Stage4 extends GameStage {
    ...
    public BodyImage ballImage() {
        return new BodyImage("data/objects/balls/skullball.png", 2.3f*ballSizeConstant());
    }
    ...
    public String getLeftCarImage() {
        return "data/objects/cars/redCarLeft.png";
    }
    ...
    public String getRightCarImage() {
        return "data/objects/cars/greenCarRight.png";
    }
    ...
    public String musicPath() {
        return "data/audio/music/stage4Music.wav";
    }
